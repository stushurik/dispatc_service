...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.decision'
        db.add_column(u'events_event', 'decision',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['decisions.Decision'], unique=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Event.decision'
        db.delete_column(u'events_event', 'decision_id')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'decision': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['decisions.Decision']", 'unique': 'True', 'null': 'True'}),
